...
export class OrgUnitFilterComponent {
  ...
  //           if (userOrgunit !== null) {
  //             const level =
  //               this.orgunitService.getUserHighestOrgUnitlevel(userOrgunit);
  //             this.orgUnitModel.userOrgUnits =
  //               this.orgunitService.getUserOrgUnits(userOrgunit);
  //             this.orgunitService.userOrgUnits =
  //               this.orgunitService.getUserOrgUnits(userOrgunit);
  ...
  //             this.store.dispatch(
  //               new TriggerAssignmentDataFiltersOrgunits(
  //                 this.orgunitService.userOrgUnits
  //               )
  //             );
  //             if (
  ...
  //             const orgunits =
  //               this.orgunitService.getuserOrganisationUnitsWithHighestlevel(
  //                 level,
  //                 userOrgunit
  //               );
  //             const use_level =
  ...
  //                   const fields =
  //                     this.orgunitService.generateUrlBasedOnLevels(use_level);
  //                   this.subscription = this.orgunitService
  ...
  //                         );
  //                         this.orgUnitModel.selectedOrgUnits =
  //                           this.orgUnitModel.selectedOrgUnits.map(
  //                             (orgUnit) => {
  ...
  //                         for (const active_orgunit of this.orgUnitModel.selectedOrgUnits.filter(
  //                           (orgUnit) => orgUnit
  //                         )) {
  //                           this.activateNode(
  //                             active_orgunit.id,
  ...
  //   let allowedLevels = [];
  //   _.each(this.selectedOrgUnits, (selectedOrgUnit) => {
  //     allowedLevels = [
  //       ...allowedLevels,
  //       ..._.filter(
  //         this.orgUnitModel.selectedLevels,
  //         (selectedLevel) => selectedLevel.level > selectedOrgUnit.level
  //       ),
  //     ];
  //   });
  //   this.orgUnitModel.selectedLevels = [...allowedLevels];
  //   if (
  ...
  //       );
  //       orgUnits.push(detailed_orgunit.id + ";LEVEL-" + detailed_orgunit.level);
  ...
  //         orgUnits.push(orgunit.id + ";LEVEL-" + orgunit.level);
  //       });
  //     }
